...
const Hero = () => {
  return (
    <div className="pt-20 bg-gradient-to-b from-white to-gray-100">
      <div className="max-w-7xl mx-0 px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in text-left">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-lg text-left">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <a href="#" className="flex items-center gap-2 bg-black text-white px-4 py-3 rounded-lg hover:bg-gray-800 transition-colors border border-input">
            ...
            <div className="relative bg-white p-6 rounded-lg shadow-xl overflow-hidden">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full flex items-center justify-center">
                <div className="absolute bottom-4 left-4 right-4 bg-card/90 text-card-foreground p-4 rounded backdrop-blur-sm z-10">
                  <p className="text-sm md:text-base text-left">Experience events without the wait. Order food, drinks, and merchandise with instant delivery.</p>
                </div>
              </div>
            </div>
          </div>

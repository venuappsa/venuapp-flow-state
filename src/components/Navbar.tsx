            ...
            <div className="relative">
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-white rounded-md shadow-lg p-1 border border-gray-200 min-w-[200px]">
                  ...
                  <DropdownMenuItem className="py-2">
                    <a href="/customer" className="w-full flex items-center">
                      <User className="mr-2 h-4 w-4 text-venu-orange" />
                      <span>For Customers</span>
                    </a>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="py-2">
                    <a href="/host" className="w-full flex items-center">
                      <Building className="mr-2 h-4 w-4 text-venu-orange" />
                      <span>For Event Hosts</span>
                    </a>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="py-2">
                    <a href="/merchant" className="w-full flex items-center">
                      <ShoppingCart className="mr-2 h-4 w-4 text-venu-orange" />
                      <span>For Merchants</span>
                    </a>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="py-2">
                    <a href="/fetchman" className="w-full flex items-center">
        ...
        <div className="md:hidden bg-white shadow-lg rounded-b-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="pl-4 border-l-2 border-gray-200 space-y-1 mt-2">
              <a href="/customer" className="block px-3 py-2 rounded-md text-sm font-medium text-venu-black hover:text-venu-orange flex items-center">
                <User className="mr-2 h-4 w-4 text-venu-orange" />
                <span>For Customers</span>
              </a>
              <a href="/host" className="block px-3 py-2 rounded-md text-sm font-medium text-venu-black hover:text-venu-orange flex items-center">
                <Building className="mr-2 h-4 w-4 text-venu-orange" />
                <span>For Event Hosts</span>
              </a>
              <a href="/merchant" className="block px-3 py-2 rounded-md text-sm font-medium text-venu-black hover:text-venu-orange flex items-center">
                <ShoppingCart className="mr-2 h-4 w-4 text-venu-orange" />
                <span>For Merchants</span>
              </a>
              <a href="/fetchman" className="block px-3 py-2 rounded-md text-sm font-medium text-venu-black hover:text-venu-orange flex items-center">
                <Truck className="mr-2 h-4 w-4 text-venu-orange" />
                <span>For Fetchmen</span>
              </a>
            </div>

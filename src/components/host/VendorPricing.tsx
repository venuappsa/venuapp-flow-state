...
export default function VendorPricing({ venueId, eventId }: VendorPricingProps) {
  ...
  const venuePricingTiers: PricingTier[] = [
    {
      ...
      price: 500,
      priceUnit: 'per day',
      description: 'Essential stall for small vendors with basic needs',
      features: [
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
        <div>
          <h2 className="text-xl font-bold">Vendor Pricing</h2>
          <p className="text-gray-500">Stall and space pricing for vendors</p>
        </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg mt-8">
        ...
        <ul className="space-y-2">
          <li className="flex items-start">
            ...
            <span>All vendor stalls must be booked at least 7 days in advance.</span>
          </li>
          <li className="flex items-start">
            <span className="bg-green-100 text-green-800 p-1 rounded mr-2">•</span>

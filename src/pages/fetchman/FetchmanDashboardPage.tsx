...
export default function FetchmanDashboardPage() {
  ...
  useEffect(() => {
    const fetchActiveDeliveries = async () => {
      if (!user?.id || !fetchmanProfile) return;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {fetchmanProfile?.verification_status === 'verified' && (
        <div className="mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center mb-2">
              <div className="mr-2 text-lg font-semibold">4.9</div>
              <div className="flex">
                {[1, 2, 3, 4, 5].map((star) => (
            ...
            <p className="text-sm text-gray-500">Based on 0 deliveries</p>
          </CardContent>
        </Card>
      </div>
    </div>

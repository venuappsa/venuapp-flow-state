    ...
    const loadFetchmanData = async () => {
      ...
      try {
        ...
        if (profileError && !profileError.message.includes('No rows found')) {
          console.error("Error loading fetchman profile:", profileError);
          throw profileError;
        }
        ...
        toast({
          ...
          description: "Could not load your fetchman information. Please try again later.",
          variant: "destructive"
        });
      } finally {
        setIsLoading(false);
        ...
        <Card>
          ...
          <CardContent className="flex flex-col items-center py-6">
            ...
            <Button 
              ...
              onClick={() => window.location.href = "/fetchman/onboarding"}
            >
